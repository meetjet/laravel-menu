...
use Meetjet\LaravelMenu\Traits\HasItems;
...
class Item implements Arrayable
{
     ...
     */
    protected Collection $visibleCallbacks;
     ...
     * @return Item|null
     */
    public function searchBy(string $key, string $value, callable $callback = null): ?Item
    {
        $matchItem = null;
     ...
     */
    private function htmlAttributes(array $attributes): HtmlString|string
    {
